<%-- 
    Document   : login
    Created on : 10 Jan, 2020, 2:48:47 PM
    Author     : root
--%>
    ...
    <div class="row justify-content-end">
      <div class="col-md-6 py-5 px-md-5">
        <div class="py-md-5">
          ...
          <form action="/TpoMS/user/login" method="post" class="appointment-form ftco-animate">
            <div class="d-md-flex">
            ...
            <div class="d-md-flex">
              ...
              <div class="form-group ml-md-4">
                <a href="register">
                  <input type="button" value="Register Here" class="btn btn-dark py-3 px-4">
                </a>
              </div>
            </div>
          </form>
